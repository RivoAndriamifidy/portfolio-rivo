...
async function main() {
    ...
    data: [
      {
        ...
        featured: true,
        order: 1,
        imageUrl: '/projects/saha-immo.jpg',
      ...
      },
      {
        ...
        tags: ['Angular', 'TypeScript', 'NestJS', 'Node.js', 'REST API'],
        featured: true,
        order: 3,
        imageUrl: '/projects/pcmi-plans.jpg',
    ...
    data: [
      {
        ...
        items: [
          ...
          'API REST avec Node.js et NestJS',
          'Conception et optimisation de bases de données MySQL / MariaDB / PostgreSQL',
  ...
  await prisma.stackItem.createMany({
    data: [
      ...
      { name: 'Node.js', category: 'Back-End', proficiency: 88, order: 3 },
      { name: 'NestJS', category: 'Back-End', proficiency: 86, order: 4 },
      { name: 'Python', category: 'Back-End', proficiency: 88, order: 5 },
      { name: 'Python Flask', category: 'Back-End', proficiency: 82, order: 6 },
      { name: 'MySQL', category: 'Back-End', proficiency: 88, order: 7 },
      { name: 'MariaDB', category: 'Back-End', proficiency: 85, order: 8 },
      { name: 'PostgreSQL', category: 'Back-End', proficiency: 80, order: 9 },
      { name: 'REST API', category: 'Back-End', proficiency: 90, order: 10 },
      { name: 'Angular', category: 'Front-End', proficiency: 90, order: 11 },
      { name: 'TypeScript', category: 'Front-End', proficiency: 88, order: 12 },
      { name: 'TailwindCSS', category: 'Front-End', proficiency: 85, order: 13 },
      { name: 'Bootstrap', category: 'Front-End', proficiency: 82, order: 14 },
      { name: 'Angular Material', category: 'Front-End', proficiency: 86, order: 15 },
      { name: 'TensorFlow', category: 'IA & Data', proficiency: 80, order: 16 },
      { name: 'Python IA', category: 'IA & Data', proficiency: 85, order: 17 },
      { name: 'Talend', category: 'IA & Data', proficiency: 78, order: 18 },
      { name: 'Git', category: 'Outils', proficiency: 90, order: 19 },
      { name: 'GitHub', category: 'Outils', proficiency: 90, order: 20 },
      { name: 'Docker', category: 'Outils', proficiency: 75, order: 21 },
    ],
  });
  ...
  await prisma.stat.createMany({
    data: [
      ...
      { label: 'Technologies', value: '21+', order: 2 },
